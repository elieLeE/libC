...
static void test_get_all_divisors_of_n(void)
{
    ...
    gv_append(&expected_divisors, 1);
    gv_append(&expected_divisors, 2);
    gv_append(&expected_divisors, 4);
    gv_append(&expected_divisors, 5);
    gv_append(&expected_divisors, 10);
    gv_append(&expected_divisors, 11);
    gv_append(&expected_divisors, 20);
    gv_append(&expected_divisors, 22);
    gv_append(&expected_divisors, 44);
    gv_append(&expected_divisors, 55);
    gv_append(&expected_divisors, 110);
    gv_append(&expected_divisors, 220);
    ...
    gv_append(&expected_divisors, 2);
    gv_append(&expected_divisors, 4);
    gv_append(&expected_divisors, 71);
    gv_append(&expected_divisors, 142);
    gv_append(&expected_divisors, 284);
    ...
    gv_append(&expected_divisors, 1);
    gv_append(&expected_divisors, 2);
    gv_append(&expected_divisors, 3);
    gv_append(&expected_divisors, 4);
    gv_append(&expected_divisors, 5);
    gv_append(&expected_divisors, 6);
    gv_append(&expected_divisors, 7);
    gv_append(&expected_divisors, 8);
    gv_append(&expected_divisors, 9);
    gv_append(&expected_divisors, 10);
    gv_append(&expected_divisors, 12);
    gv_append(&expected_divisors, 14);
    gv_append(&expected_divisors, 15);
    gv_append(&expected_divisors, 18);
    gv_append(&expected_divisors, 20);
    gv_append(&expected_divisors, 21);
    gv_append(&expected_divisors, 24);
    gv_append(&expected_divisors, 28);
    gv_append(&expected_divisors, 30);
    gv_append(&expected_divisors, 35);
    gv_append(&expected_divisors, 36);
    gv_append(&expected_divisors, 40);
    gv_append(&expected_divisors, 42);
    gv_append(&expected_divisors, 45);
    gv_append(&expected_divisors, 49);
    gv_append(&expected_divisors, 56);
    gv_append(&expected_divisors, 60);
    gv_append(&expected_divisors, 63);
    gv_append(&expected_divisors, 70);
    gv_append(&expected_divisors, 72);
    gv_append(&expected_divisors, 84);
    gv_append(&expected_divisors, 90);
    gv_append(&expected_divisors, 98);
    gv_append(&expected_divisors, 105);
    gv_append(&expected_divisors, 120);
    gv_append(&expected_divisors, 126);
    gv_append(&expected_divisors, 140);
    gv_append(&expected_divisors, 147);
    gv_append(&expected_divisors, 168);
    gv_append(&expected_divisors, 180);
    gv_append(&expected_divisors, 196);
    gv_append(&expected_divisors, 210);
    gv_append(&expected_divisors, 245);
    gv_append(&expected_divisors, 252);
    gv_append(&expected_divisors, 280);
    gv_append(&expected_divisors, 294);
    gv_append(&expected_divisors, 315);
    gv_append(&expected_divisors, 360);
    gv_append(&expected_divisors, 392);
    gv_append(&expected_divisors, 420);
    gv_append(&expected_divisors, 441);
    gv_append(&expected_divisors, 490);
    gv_append(&expected_divisors, 504);
    gv_append(&expected_divisors, 588);
    gv_append(&expected_divisors, 630);
    gv_append(&expected_divisors, 735);
    gv_append(&expected_divisors, 840);
    gv_append(&expected_divisors, 882);
    gv_append(&expected_divisors, 980);
    gv_append(&expected_divisors, 1176);
    gv_append(&expected_divisors, 1260);
    gv_append(&expected_divisors, 1470);
    gv_append(&expected_divisors, 1764);
    gv_append(&expected_divisors, 1960);
    gv_append(&expected_divisors, 2205);
    gv_append(&expected_divisors, 2520);
    gv_append(&expected_divisors, 2940);
    gv_append(&expected_divisors, 3528);
    gv_append(&expected_divisors, 4410);
    gv_append(&expected_divisors, 5880);
    gv_append(&expected_divisors, 8820);
    gv_append(&expected_divisors, 17640);
